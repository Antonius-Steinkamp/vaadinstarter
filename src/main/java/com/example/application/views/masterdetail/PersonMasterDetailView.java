...
@Route(value = "person-master-detail/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class PersonMasterDetailView extends Div implements BeforeEnterObserver {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2963498069612805418L;
	private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "person-master-detail/%s/edit";
    ...
    public PersonMasterDetailView(SamplePersonService samplePersonService) {
        ...
        grid.addColumn(
                new ComponentRenderer<>(
                        person -> {
                            ...
                            checkbox.setValue( person.isImportant() );                            
                            return checkbox;
                        }
                )
